        ...
        var N = e.frame = function() {
            ...
            q = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (N(n), e = P(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: d.ease[1],
                    from: 0,
    ...
    i.define("dropdown", t.exports = function(t, e) {
        ...
        function C(e, r) {
            ...
            n && l.el.on(O, function(t) {
                return function(e, n) {
                    n = n || {}, L(t), !0 === n.open && S(t), !1 === n.open && I(t, {
                        immediate: !0
                    })
                }
        ...
        function R(t, e) {
            return c(function(n) {
                if (t.open || n && "w-close" === n.type) return I(t, {
                    forceClose: e
                });
                S(t)
            })
        ...
        function F(t, e) {
            if (!t.open) {
                ...
                var r = $(t),
                    ...
                    u = t.el.height(),
                    c = t.el[0];
                if (P(0, c), k.intro(0, c), i.redraw.up(), s || f.on("click" + m, t.outside), e) p();
                else {
